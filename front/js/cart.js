...
// la page confirmation et panier
const page = document.location.href;

// Récupération des produits de l'api
//----------------------------------------------------------------

// appel de la ressource api product si on est sur la page panier
if (page.match("cart")) {
...
function affiche(indexé) {
  ...
  `<article class="cart__item" data-id="${choix._id}" data-couleur="${choix.couleur}" data-quantité="${choix.quantité}" data-prix="${choix.prix}"> 
    ...
    // remplace les virgules de jonctions des objets du tableau par un vide
    
  totalProduit()
}

// modifie dynamiquement les quantités du panier
//--------------------------------------------------------------
